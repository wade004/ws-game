...
提交链：`34248a8`（T-N2-1）、`8c596aa`（T-N2-2）、`b298e5a`（T-N2-3）、`a926442`（T-N2-4）、`09bf0ef`（T-N2-5）、`15d483d`（T-N2-6）、`ae139a4`（T-N2-7）、`6c1741d`（T-N2-8 ★确定性敏感）、`cf566a0`（T-N2-9，`n2/inventory` 并行分支，`--no-ff` 合入本分支的合并提交 `6123406`）、`8330ec8`（T-N2-8b）、`1f82dbd`（T-N2-10）、`e714a81`（T-N2-11 前半：补阻断校验），分支 `n2/equipment`，`--no-ff` 合入 `main`（合并提交哈希待补），本笔提交（T-N2-11 后半：阶段 N2 文档收尾——裁定落地、04/07 勘误、落地进度记录、1.32.0 变更记录）。
