...
消费方反馈第 61 条（角度弧度制集中声明）、第 56 条追问（quest_prerequisite/talent_tree 孤立节点
可选诊断，对 1.41.0 处置结果的回应）。
...
- 05 文档第 3.5 节 `Shape` 字段表 `direction`/`angle`/`rotation` 参数补"（弧度）"标注（第 61 条）。
