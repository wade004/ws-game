...
- **数值设计落地阶段 N3 · T-N3-5（Unreleased）**：新增校验检查名 `skill_no_time_cost`（04 第 5
...
- **数值设计落地阶段 N3 · T-N3-8（Unreleased）**：`target.chain_def` 新增可选字段
