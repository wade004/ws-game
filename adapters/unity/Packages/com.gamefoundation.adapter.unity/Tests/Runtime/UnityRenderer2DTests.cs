...
namespace Adapter.Unity.Tests.Runtime
{
    public sealed class UnityRenderer2DTests
    {
        ...
        public void DestroySpriteInstance_ThenReuse_Throws()
        {
            ...
            Assert.Throws<System.InvalidOperationException>(() => _renderer.SetTransform(handle, Vec2.Zero, 0, 0, 0, 1, false));
        }
        ...
        public void SetTransform_SetsPositionAndComputesSortingOrderFromLayerAndSortY()
        {
            ...
            _renderer.SetTransform(handle, new Vec2(1.5, 2.5), sortY: 2.5, layer: 1, rotation: 0, scale: 1, flipX: false);
        ...
        [Test]
        public void SetShaderParam_HeightOffset_MovesLayersRootLocalY()
        {
            var handle = _renderer.CreateSpriteInstance(new Id("sprite.creature.sample_wolf"));

            _renderer.SetShaderParam(handle, "height_offset_px", 100.0);
