...
static class CoreBoundaryProbe
{
    ...
    static void Main(){Console.WriteLine("CORE-BOUNDARY-INDEPENDENT-PROBE head=24a11fe28f9647cd532c41f56f7ab18c00fb8516 version=1.16.1"); ExprValueInvalidId(); QuestObjectiveReload(); StatQueryOrder(); EconomyNoneToTimer();}
    static void ExprValueInvalidId()
    {
        ...
        Console.WriteLine("ORACLE=IsValid must return false without throwing for malformed Id; Parse may throw FormatException, and formal Quest/Dialog validators must convert it to a blocking report before runtime consumers.");
    }
