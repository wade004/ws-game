...
static class SkillHotReloadBoundaryProbe
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine("INTERPRETATION-CURRENT=registry exposes cooldown=5 and damage=99; after DataLoadCompleted the existing host second cast observes damage=99 and cooldown=5, matching a fresh real host. FakeCombatHost damage is EffectContext.BaseValue, not HP. Process exit 0 is not semantic proof.");
    }
}
