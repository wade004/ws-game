...
基线为 7e63d6695644644e20f30e006b9efa7e531afa34。本目录只放复现工程与结果说明；原始输出已复制到 `../evidence/`（已按"生成物不进 git"规则出库，提交 `24302836`，内容可用 `git show 24302836^:<路径>` 取回），未启动 Unity、未发布、未接触主目录用户存档。
