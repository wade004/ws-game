...
architecture/          架构文档集（已定稿），本仓库唯一的规范来源；00~14 号文档 + adr/（43 条 ADR，含 ADR-0044；编号 0043 由并行任务占用、待其合并后补齐）+ 落地计划/ + 选型/
...
- ADR 索引（43 条架构决策记录，含 ADR-0044；编号 0043 由并行任务占用、待其合并后补齐）：[architecture/adr/README.md](architecture/adr/README.md)
